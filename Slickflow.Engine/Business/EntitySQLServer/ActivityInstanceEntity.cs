...
namespace Slickflow.Engine.Business.Entity
{
    ...
    public class ActivityInstanceEntity
    {
        ...
        [Column(TypeName = "nvarchar(1000)", Order = 10)]
        [MaxLength(1000)]
        public string AssignedToUserIDs { get; set; }

        [Column(TypeName = "nvarchar(2000)", Order = 11)]
        [MaxLength(2000)]
        ...
        [Required]
        [Column(TypeName = "nvarchar(50)", Order = 25)]
        [MaxLength(50)]
        public string CreatedByUserName { get; set; }

        [Required]
        [DatabaseGenerated(DatabaseGeneratedOption.Computed)]
        [Column(TypeName = "datetime2", Order = 26)]
        ...
        [Column(TypeName = "nvarchar(50)", Order = 28)]
        [MaxLength(50)]
        public string LastUpdatedByUserName { get; set; }

        [Column(TypeName = "datetime2", Order = 29)]
        public Nullable<System.DateTime> LastUpdatedDateTime { get; set; }

        [Column(TypeName = "datetime2", Order = 30)]
        ...
        [Column(TypeName = "nvarchar(50)", Order = 32)]
        [MaxLength(50)]
