...
namespace NETBPMFlow.Engine.Utility
{
    /// <summary>
    ...
    public class XMLHelper
    {
        ...
        /// <returns>属性值</returns>
        public static string GetXmlAttribute(XmlNode xmlNode, string attributeName, bool isLowerCase = false)
        {
            try
            {
                ...
                {
                    return xmlNode.Attributes[attributeName.ToLower()].InnerText;
                }
                else
                {
                    return null;
